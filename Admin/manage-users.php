...
if (isset($_GET['uid']) && $_GET['action'] == 'del') {
	$userid = $_GET['uid'];
	$query = mysqli_query($con, "delete from register where id='$userid'");
							...
							<div class="module-body table">
								...
								<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display" width="100%">
									...
									<tbody>
										...
										<?php $query = mysqli_query($con, "select * from register");
										$cnt = 1;
										...
										?>
											<tr>
												...
												<td><a href="javascript:void(0);" onClick="popUpWindow('http://localhost/IMS/Admin/userprofile.php?uid=<?php echo htmlentities($row['id']); ?>');" title="View Details">
