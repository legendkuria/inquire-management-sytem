...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        $uid = $_SESSION['id'];
        $detail = mysqli_fetch_array(mysqli_query($con,"SELECT * FROM register where id=$uid"));
        $emails= $detail['email'];
        $det=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM register where id=$uid"));
        $category = $_POST['category'];
        $cat=mysqli_fetch_array(mysqli_query($con,"SELECT * FROM category where id=$category"));
        ...
        $query = mysqli_query($con, "insert into inquiries(userid,email,category,categoryname,inquirydetails,inquiryfile) values('$uid','$emails','$category','$cats','$inquirydetails','$inquiryfile')");
        //
...
//Set sender email
	...
	$mail->setFrom('ke734cynthiawangari@gmail.com',$nam);
//Enable HTML
	$mail->isHTML(true);
//Attachment
...
//Email body
	...
	$mail->Body = "
    <h1 >Inquiry</h1><br><p>I,$nam has made $cats inquiry</p>";
//Add recipient
                        ...
                        <div class="col-lg-12">
                            <div class="form-panel">
                                <form class="form-horizontal style-form" method="post" name="inquiry" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">Inquiry Details (max 200 words) </label>
                                        <div class="col-sm-6">
